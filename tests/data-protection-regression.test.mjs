...
assert.match(serviceWorker, /work-manager-v10-shell-2026-09-13-32/, "7단계 서비스워커 캐시를 사용해야 합니다.");
assert.match(html, /cloud-sync\.js\?v=20260913-32/, "새 클라우드 동기화 모듈 URL을 사용해야 합니다.");
