...
assert.match(serviceWorker, /work-manager-v10-shell-2026-09-13-32/, "7단계 배포 캐시에서도 통합검색·과거이력이 유지되어야 합니다.");
assert.match(html, /navigator\.serviceWorker\.register\('\.\/sw\.js\?v=20260913-32'\)/, "새 서비스워커 URL을 등록해야 합니다.");
